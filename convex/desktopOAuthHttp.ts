...
export function registerDesktopOAuthRoutes(http: ReturnType<typeof httpRouter>): void {
  ...
  const getRoutes = [
    [
      `${DESKTOP_OAUTH_PREFIX}/.well-known/openid-configuration`,
      oauthProvider.handlers.openIdConfiguration,
    ],
    [
      `${DESKTOP_OAUTH_PREFIX}/.well-known/oauth-authorization-server`,
      oauthProvider.handlers.openIdConfiguration,
    ],
    [`${DESKTOP_OAUTH_PREFIX}/.well-known/jwks.json`, oauthProvider.handlers.jwks],
    [
      `${DESKTOP_OAUTH_PREFIX}/.well-known/oauth-protected-resource`,
      oauthProvider.handlers.protectedResource,
    ],
