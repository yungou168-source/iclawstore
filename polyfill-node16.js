  ...
  if (name === "util" || name === "node:util") {
    if (!mod.styleText) {
      mod.styleText = function (style, text) {
        ...
        if (s === "reset" || s === "bold" || s === "dim" || s === "italic" ||
            s === "underline" || s === "blink" || s === "overline" || s === "inverse") {
          return "\x1b[" + { bold: 1, dim: 2, italic: 3, underline: 4, blink: 5, overline: 6, inverse: 7, reset: 0 }[s] + "m" + text + "\x1b[0m";
        }
        if (s === "red" || s === "green" || s === "yellow" || s === "blue" ||
            s === "magenta" || s === "cyan" || s === "white" || s === "gray" ||
            s === "grey" || s === "black" || s === "bgBlack" || s === "bgRed" ||
            s === "bgGreen" || s === "bgYellow" || s === "bgBlue" ||
            s === "bgMagenta" || s === "bgCyan" || s === "bgWhite") {
          const codes = {
