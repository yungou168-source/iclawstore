...
async function build() {
  ...
  function handleRollupWarning(warning, warn) {
    ...
    if (warning.code === 'UNUSED_EXTERNAL_IMPORT' && /@tanstack\/start-/.test(warning.message)) return;
    if (warning.code === 'EMPTY_BUNDLE' || /Generated an empty chunk/i.test(warning.message)) return;
    warn(warning);
  }
