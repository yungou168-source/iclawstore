...
try {
  ...
  try { ({ default: tailwindcss } = await import('@tailwindcss/vite')); } catch(e) {}
  try { ({ devtools } = await import('@tanstack/devtools-vite')); } catch(e) {}
  try { ({ tanstackStart } = await import('@tanstack/react-start/plugin/vite')); } catch(e) {}
  try { ({ default: viteReact } = await import('@vitejs/plugin-react')); } catch(e) {}
  try { ({ nitro } = await import('nitro/vite')); } catch(e) { nitroLoadError = e.message; }
}
