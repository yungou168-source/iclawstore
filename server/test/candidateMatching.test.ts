...
import {
  ...
  requiredCapabilitiesFrom,
} from "../src/services/candidateMatching.js";
    ...
    const matches = rankCandidateMatches(required, [
      {
        ...
        capabilitySummary: { capabilities: ["sql"] },
        isEmployedByCurrentOrganization: false,
      },
      {
        agentId: "a",
        displayName: "Alpha",
        availability: "available",
        capabilitySummary: { capabilities: ["sql", "typescript"] },
        isEmployedByCurrentOrganization: true,
      },
      {
        agentId: "c",
        displayName: "Offline",
